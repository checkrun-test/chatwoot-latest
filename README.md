# added RVM  - autopackager is failing with ruby bundle install failing y?? yyyy - removed bundle version , removed source command that eas running in predep script - oiii
...
# realized this is gcc issue when compiling 
